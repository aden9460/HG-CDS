...
parser.add_argument(
    ...
    default=1,
    type=float,
    help='Contrast loss coefficient, adjust the proportion of contrast loss')
...
parser.add_argument('--kd', default=1, type=float, help='KD loss coefficient')
parser.add_argument('--temp', default=4, type=float, help='Temperature for distillation')
parser.add_argument('--model_teacher', default='resnet18_1w1a', type=str)
